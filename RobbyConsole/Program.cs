...
namespace RobbyConsole
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var manager = new RuleManager(logger, repo, defRepo, setRepo, handler, calc,prices);
            var validator = new RuleValidator(logger, repo, defRepo, setRepo,calc,trade, dataRepo);
            ...
            var k4 = new Kline { Symbol = "ETHBTC", Interval = "5m", OpenTime = 1527812100000, CloseTime = 1527812399999, Open = 0.00162910m, Close = 0.05162920m, High = 0.00163170m, Low = 0.00162820m, Volume = 27189.2000000m };
            var k5 = new Kline { Symbol = "ETHBTC", Interval = "5m", OpenTime = 1527812400000, CloseTime = 1527812699999, Open = 0.00162930m, Close = 0.07163210m, High = 0.00163400m, Low = 0.00162720m, Volume = 41544.6300000m };
            var k6 = new Kline { Symbol = "ETHBTC", Interval = "5m", OpenTime = 1527812700000, CloseTime = 1527812999999, Open = 0.00163170m, Close = 0.09163000m, High = 0.00163410m, Low = 0.00162800m, Volume = 31390.5200000m };
            var k7 = new Kline { Symbol = "ETHBTC", Interval = "5m", OpenTime = 1527813000000, CloseTime = 1527813299999, Open = 0.00163180m, Close = 0.12162950m, High = 0.00163280m, Low = 0.00162950m, Volume = 39613.3100000m };
            ...
            var k9 = new Kline { Symbol = "ETHBTC", Interval = "5m", OpenTime = 1527813600000, CloseTime = 1527813899999, Open = 0.00163250m, Close = 0.02163370m, High = 0.00163420m, Low = 0.00163180m, Volume = 45087.0700000m };
            var k10 = new Kline { Symbol = "ETHBTC", Interval = "5m", OpenTime = 1527813900000, CloseTime = 1527814199999, Open = 0.00163380m, Close = 0.03163290m, High = 0.00163420m, Low = 0.00163080m, Volume = 35669.8000000m };
            var k11 = new Kline { Symbol = "ETHBTC", Interval = "5m", OpenTime = 1527814200000, CloseTime = 1527814499999, Open = 0.00163290m, Close = 0.02163390m, High = 0.00163530m, Low = 0.00163110m, Volume = 25887.0500000m };
            var k12 = new Kline { Symbol = "ETHBTC", Interval = "5m", OpenTime = 1527814500000, CloseTime = 1527814799999, Open = 0.00163230m, Close = 0.03163090m, High = 0.00163370m, Low = 0.00163000m, Volume = 18803.4800000m };
            var k13 = new Kline { Symbol = "ETHBTC", Interval = "5m", OpenTime = 1527814800000, CloseTime = 1527815099999, Open = 0.00163090m, Close = 0.02163110m, High = 0.00163320m, Low = 0.00162880m, Volume = 24896.6000000m };
