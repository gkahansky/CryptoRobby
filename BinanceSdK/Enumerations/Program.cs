...
namespace M3C.Finance.Binance.Example
{
    class Program
    {
        ...
        static void SignedEndpointExamples()
        {
            ...
            var restClient = new BinanceClient(System.Configuration.ConfigurationManager.AppSettings["BinanceApiKey"], System.Configuration.ConfigurationManager.AppSettings["BinanceApiSecret"]);
